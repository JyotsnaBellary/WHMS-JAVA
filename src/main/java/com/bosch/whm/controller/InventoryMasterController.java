...
//	            Product product=new Product(productCode,name,currentStock,dimension,weight);;
	           ...
	           System.out.println("Total Incventory count is " + inventoryMasterBOService.inventoryCountUpdateService());
	           System.out.println("Total Incventory count is " + inventoryMasterBOService.decreaseInventoryCountService());
	           System.out.println("Total Incventory count is " + inventoryMasterBOService.increaseInventoryCountService());
